...
import com.vsii.bookstore.message.request.LoginForm;
import com.vsii.bookstore.message.request.PasswordForm;
import com.vsii.bookstore.message.request.SignUpForm;
import com.vsii.bookstore.message.request.UserForm;
import com.vsii.bookstore.message.response.JwtResponse;
import com.vsii.bookstore.message.response.ResponseMessage;
...
import com.vsii.bookstore.security.services.UserPrinciple;
...
public class AuthRestAPIs {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
        ...
        User user = new User(signUpRequest.getName(), signUpRequest.getUsername(), signUpRequest.getEmail(), signUpRequest.getPhone(), signUpRequest.getAddress(),
